...
class Cifar10Net(nn.Module):
    def __init__(self, time_steps=8, v_threshold=1.0, v_reset=0.0, tau=2.0, surrogate_function=surrogate.ATan()):
        super().__init__()
        ...
        self.conv = nn.Sequential(
            neuron.LIFNode(v_threshold=v_threshold, v_reset=v_reset, tau=tau, surrogate_function=surrogate_function,
                           detach_reset=True),
